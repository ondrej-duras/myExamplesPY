...
PIX = [ [2,0], [3,0], [4,0], [4,1], [4,2], [4,3], [4,4],
        ...
        [0,0], [1,0] ]
SEVER = Image("00700:07070:70007:70007:70007")
AZI = 0
...
while True:
  ...
  if a and b:
    display.scroll("Vsetko najlepsie k meninam Mato")
    # kalibrovat netreba, ono sa to samo
    # compass.calibrate()
    continue

  if a:
    smer = compass.heading()
    display.scroll("<"+str(smer)+">")
    continue
